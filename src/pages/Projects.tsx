    ...
    <div id="Projects" className="pb-72 mt-20">
      ...
      <div className="mx-12 lg:mx-60">
        {projectsData.map((project, index) => (
          <div key={index} className="bg-[#1a1a1a] p-8 rounded-lg mb-20">
            {" "}
            {/* Added background, padding, and rounded corners */}
            <div className="flex flex-col lg:flex-row mb-28">
              {" "}
              {/* Increased mb-20 to mb-28 */}
              <div className="lg:w-1/2 lg:pr-8">
                <h2 className="text-2xl text-[#e6f1ff] mb-2">
                  {project.title}
                </h2>
